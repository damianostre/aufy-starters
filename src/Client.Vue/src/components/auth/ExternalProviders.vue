<template>
    <div class="grid grid-cols-2 gap-4">
        ...
        <a
            ...
            style="max-width: 15rem"
        >
            <svg class="h-5 w-5 block" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                <path
                    fill-rule="evenodd"
...
import type { ChallengeMode } from 'aufy-client/src/types';
...
const challenge = (provider: string) => {
    ...
    aufy.externalChallenge({ provider, mode: props.mode });
    disabled.value = true;
};
</script>
